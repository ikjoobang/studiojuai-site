...
$('.gallery-item').die('click').live('click', function(e) {
    ...
    if($('#gframe-' + eid + ' .gallery-top-button').length == 0) $('#gframe-' + eid + ' a.close').wrap('<div class="gallery-top-button"></div>');
...
var setSlideImgScale = function($slide, scale) {
	...
	if(slideFrame.hasClass('blueimp-gallery-playing')) {
		slideFrame.find('.play-pause').click();
	}
