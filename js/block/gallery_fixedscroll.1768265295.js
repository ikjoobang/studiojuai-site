...
let Fixedscroll3 = class {
    ...
    gjs_load(gTarget) {
        ...
        var gseq = $(gTarget).closest('.'+elDefaultClass).attr('data-id'),
            ...
            swp_view_mc = eLStyles.getPropertyValue('--swiper-view-mc'),
            layout_m_on = (eLStyles.getPropertyValue('--layout-m-on')) ? eLStyles.getPropertyValue('--layout-m-on') : 0;
        ...
        swp_view_m = (typeof swp_view_mc != 'undefined' && layout_m_on != 0) ? parseFloat(swp_view_mc) : (typeof swp_view_m != 'undefined' && swp_view_m) ? parseFloat(swp_view_m) : 1.2;
