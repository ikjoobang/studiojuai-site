var style = new function () {
	...
	this.selectGoogleCalendarSync = function(cls,fn,elname) { 
		var now_palette_html = '',
			clr_picker = '',
			pn = '--google-sync-color',
			selector = '.'+elname+' .fc',
			color = fn;

		clr_picker = getColorisHtml(color,'googlecalendarsync',{'pn':pn, 'el':selectEL, 'selector':selector},'thumbnail',true,{'input':'clr-alphaoff clr-tooltipoff'});
		now_palette_html += `
				<div class="calendar-line-color">
					${clr_picker}
				</div>
